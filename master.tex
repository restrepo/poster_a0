...
\only<1->{\put(250,180){\begin{overpic}[scale=0.2]{brickY}\end{overpic}}}%
\only<1->{\put(340,180){\begin{overpic}[scale=0.2]{brickR}\end{overpic}}}%
\only<1->{\put(210,120){\begin{overpic}[scale=0.2]{brickB}\end{overpic}}}%
\only<1->{\put(120,40){\begin{overpic}[scale=0.2]{brickssY}\end{overpic}}}%
\only<1->{\put(200,40){\begin{overpic}[scale=0.2]{brickssR}\end{overpic}}}%
\only<1->{\put(280,40){\begin{overpic}[scale=0.2]{brickssB}\end{overpic}}}%
\end{picture}
\end{frame}
