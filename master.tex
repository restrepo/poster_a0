...
\end{align*}
    ...
    \begin{column}{0.53\textwidth}
      ...
      \invisible<1>{\only<1-2>{\includegraphics[scale=0.38]{GCE}}\only<3>{\includegraphics[scale=0.38]{GCE2016}}}%
      \invisible<1>{\tiny S. Horiuchi, O. Macias, DR, A. Rivera, O. Zapata, 1602.04788 (JCAP)  }
    \end{column}
  \end{columns}
