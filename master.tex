...
\only<1->{\put(100,100){\begin{overpic}[scale=0.352]{mice}\end{overpic}}}%
%
\only<1->{\put(240,180){\begin{overpic}[scale=0.15]{brickY}\end{overpic}}}%
\only<1->{\put(310,180){\begin{overpic}[scale=0.15]{brickR}\end{overpic}}}%
\only<1->{\put(380,180){\begin{overpic}[scale=0.15]{brickB}\end{overpic}}}%
\only<1->{\put(190,120){\begin{overpic}[scale=0.15]{brickG}\end{overpic}}}%
\only<1->{\put(260,120){\begin{overpic}[scale=0.15]{brickW}\end{overpic}}}%
\only<1->{\put(330,120){\begin{overpic}[scale=0.15]{brickK}\end{overpic}}}%
\only<1->{\put(120,40){ \begin{overpic}[scale=0.15]{brickssY}\end{overpic}}}%
\only<1->{\put(190,40){ \begin{overpic}[scale=0.15]{brickssR}\end{overpic}}}%
\only<1->{\put(260,40){ \begin{overpic}[scale=0.15]{brickssB}\end{overpic}}}%
\only<1->{\put(90,0){ \begin{overpic}[scale=0.15]{brickssG}\end{overpic}}}%
\only<1->{\put(160,0){ \begin{overpic}[scale=0.15]{brickssW}\end{overpic}}}%
\only<1->{\put(230,0){ \begin{overpic}[scale=0.15]{brickssK}\end{overpic}}}%
\end{picture}
\end{frame}
