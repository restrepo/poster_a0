...
\only<3->{\put(\px,\py){%\includegraphics[scale=\pscale]{dm3}
    \begin{overpic}[scale=\pscale,grid]{dm3}
    \end{overpic}
  }}%  
%%% circle
\only<1>{\put(80,50){$\left( \psi_L \right)^{\dagger}\nu_R\sigma \to
    \nu_R \nu_R \sigma  $ }}
\only<4>{\put(72,133){\tikz \draw[red,thick,rounded corners] (0,0) rectangle (0.5,0.5);} }
\only<4>{\put(125,143){\tikz \draw[red,thick,rounded corners] (0,0) rectangle (0.5,0.5);} }
\only<4>{\put(147,143){\tikz \draw[red,thick,rounded corners] (0,0) rectangle (0.5,0.5);} }
\only<3->{\put(0,70){
    \begin{columns}
...
\hline
 ...
 $L_i=\begin{pmatrix}\nu_L& e_L\end{pmatrix}_i^{\operatorname{T}}$                           & $-1$ & $ \left(\mathbf{1},\mathbf{2}\right)_{-1/2}$  \\
 $\overline{\nu_{Ri}}$ & $+1$ & $ \left(\mathbf{1},\mathbf{1}\right)_0$ \\ 
 $\mathcal{Q}_L$    & $-r$ & $ \left(\mathbf{N}_c,\mathbf{1}\right)_0$\\
 $ \overline{\mathcal{Q}_R} $ & $r$ & $ \left(\mathbf{N}_c,\mathbf{1}\right)_0$ \\
 $H$                           &          0  & $ \left(\mathbf{1},\mathbf{2}\right)_{1/2}$ \\ 
 $\sigma_a$                           &  $1-r$   & $ \left(\mathbf{N}_{c},\mathbf{1}\right)_0$ \\
 $\eta_a$                        &  $1-r$   & $ \left(\mathbf{N}_c,\mathbf{2}\right)_{1/2}$ \\
\hline
  \end{tabular}
