...
\title{Models with radiative neutrino masses\\ and viable dark matter candidates}
\subtitle{\textbf{JHEP 1311 (2013) 011 }}
...
\url{http://gfif.udea.edu.co}      
    ...
    \begin{column}{0.5\textwidth}
       \hfill \includegraphics[scale=0.4]{gfif}\\
...
\alert{In collaboration with}\\
  Carloa~Yaguna (UPTC) \& Oscar~Zapata (UdeA)}
%\centering
}
...
\begin{picture}(320,250)
\only<1->{\put(-24,-22){\begin{overpic}[scale=0.352]{z2_bkg}\end{overpic}}}%
\only<1->{\put(180,20){\begin{overpic}[scale=0.25]{inverse_type1}\end{overpic}}}%
...
\color{red} $ ({\hat\Psi}_R)^{\dagger} $ & $ ( \eta^{\alpha}_2\ \eta^{\alpha}_3)^{\operatorname{T}} $ & $ \mathbf{1} $ & $ \mathbf{1} $ & $ +1 $ & $ \color{red} -1$ \\
\color{red} $\Psi_L $ & $ (\xi_{3\alpha}\ \xi_{4\alpha})^{\operatorname{T}} $ & $ \mathbf{1} $ & $ \mathbf{1} $ & $ -1 $ & $\color{red} -1$ \\
\color{red} $N $ & $ \eta_{4\alpha} $ & $ \mathbf{1} $ & $ \mathbf{1} $ & $ 0 $ & $\color{red} -1$ \\
...
(\xi_{1\alpha}  \  \xi_{2\alpha} )^{\operatorname{T}}$ & $ \mathbf{1} $ & $ \mathbf{2} $ & $ -1/2 $ & $ +1$\\
$(e_R)^{\dagger} $ & $ \eta^{\alpha}_1 $ & $ \mathbf{1} $ & $ \mathbf{1} $ & $ +1 $ & $ +1$ \\
\color{red} $ (\psi_R^{0})^{\dagger} $ & $ \eta^{\alpha}_2$ & $ \mathbf{1} $ & $ \mathbf{1} $ & $ +1 $ & $ \color{red} -1$ \\
\color{red} $\psi_L^{0} $ & $ \xi_{3\alpha} $ & $ \mathbf{1} $ & $ \mathbf{1} $ & $ -1 $ & $\color{red} -1$ \\
\color{red} $N $ & $ \eta_{4\alpha} $ & $ \mathbf{1} $ & $ \mathbf{1} $ & $ 0 $ & $\color{red} -1$ \\
\color{red} $S$ &  & $ \mathbf{1} $ & $ \mathbf{1} $ & $ 0 $ & $\color{red} -1$ \\
 \end{tabular}
  \end{center}
...
\includegraphics[scale=0.5]{hpf}    
  \end{column}
  \begin{column}{0.33\textwidth}
Basis $\boldsymbol{\psi}^0=\left({\color{red}N},{\color{red}\psi_L^0},{\color{red}\left( \psi_R^0 \right)^{\dagger}}\right)^T$ 
\tiny
\begin{align*}
  &\mathcal{M}_{\boldsymbol{\psi}^0}=\nonumber\\
&\begin{pmatrix}
{\color{red}M_N}               &{\color{red}-y\,c_\beta v/\sqrt{2}}&{\color{red}y\,s_\beta v/\sqrt{2}} \\
{\color{red}-y\,c_\beta} v/\sqrt{2}  & 0            & {\color{red}}-M_D\\
{\color{red}y\,s_\beta v/\sqrt{2}} &{\color{red}}  -M_D                &  0  \\
\end{pmatrix},
\end{align*}
...
\begin{frame}
  \frametitle{Scalar dark matter: vector-like portal}
  \begin{center}
\rowcolors{1}{RoyalBlue!20}{}
%\def\arraystretch{1.1}
   \begin{tabular}{llllll}
